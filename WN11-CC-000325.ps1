<#
.SYNOPSIS
    Remediates STIG WN11-CC-000325 by disabling "Sign-in last interactive user automatically
    after a system-initiated restart" via DisableAutomaticRestartSignOn = 1.
...
.USAGE
    ...
    Example:
    PS C:\> .\WN11-CC-000325-Disable-Automatic-Restart-SignOn.ps1
