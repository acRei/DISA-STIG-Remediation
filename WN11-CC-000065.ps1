<#
.SYNOPSIS
    Remediates STIG WN11-CC-000065 by disabling Wi-Fi Sense auto-connect behavior
    (suggested open hotspots / shared networks / paid hotspot services) via
...
.USAGE
    ...
    Example:
    PS C:\> .\WN11-CC-000065-Disable-WiFi-Sense.ps1
